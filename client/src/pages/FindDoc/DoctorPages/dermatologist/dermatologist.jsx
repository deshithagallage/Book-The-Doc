...
import './dermatologist.css'; // Assuming you have a CSS file for styling

import dermatologistImage from '../../../../images/DoctorImages/dermatologist.jpg';
    ...
    <div className="find-doc-container">
      ...
      <main className="main-content">
        ...
        <div className="doctor-image">
          <img src={dermatologistImage} width="300" height="300" alt="Cardiologist" />
        </div>
        </div>
