        ...
        <div className={styles.content}>
          ...
          <div className={styles.cardsContainer}>
            <div className={`${styles.card} ${styles.ongoingAppointment}`}>
              ...
              <p>
                <strong>Patient:</strong> {ongoingAppointment.patientName}
              </p>
              <p>
                <strong>Time:</strong> {ongoingAppointment.time}
              </p>
              <p>
                <strong>Description:</strong> {ongoingAppointment.description}
              </p>
            </div>
